        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <p class="mb-5">거리영상기반 보행환경 설문조사 사이트의 목적은 설문참여자들이 주어진 거리영상 셋(전주시 로드뷰)에 대한 쌍체비교 평가를 통해 정성적 DB를 구축하는 것으로, 향후 딥러닝 모델 개발 및 이를 기반으로 전주시 보행환경 개선을 위한 데이터로 활용될 것입니다.</p>                                        
                </div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p class="ls2 lh6 bs5 ts4">
						<em class="emphasis">< 인포랩 >('info.rlog.kr'이하 '거리영상설문사이트')</em>은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
					</p>
					<p class="ls2">
						○ 이 개인정보처리방침은 <em class="emphasis">2021</em>년 <em class="emphasis">11</em>월 <em class="emphasis">25</em>부터 적용됩니다.
					</p>
					</br>
					<p class='lh6 bs4'>
						<strong>제1조(개인정보의 처리 목적)<br />
						<br />
						<em class="emphasis">< 인포랩 >('info.rlog.kr'이하 '거리영상설문사이트')</em>은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
						</strong>
					</p>
					...
					<p class='lh6 bs4'>
						...
						</br>① <em class="emphasis">< 인포랩 ></em>은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</br>
					...
					<p class="ls2">
						<br />
						<br />① 정보주체는 인포랩에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
					</p>
					<p class='sub_p'>② 제1항에 따른 권리 행사는인포랩에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 인포랩은(는) 이에 대해 지체 없이 조치하겠습니다.</p>
					...
					<p class='sub_p'>⑥ 인포랩은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.</p>
					</br>
					</br>
					<p class='lh6 bs4'>
						<strong>제4조(처리하는 개인정보의 항목 작성) </strong></br>
						</br> ① <em class="emphasis">< 인포랩 ></em>은(는) 다음의 개인정보 항목을 처리하고 있습니다.
					</p>
					<ul class='list_indent2 mgt10'>
						<li class='tt'>1< 홈페이지 회원가입 및 관리 ></li>
						<li>필수항목 : 이메일, 휴대전화번호, 자택주소, 로그인ID, 성별, 생년월일, 이름</li>
						<li>선택항목 :</li>
					</ul>
					</br>
					</br>
					...
					<p class='ls2'>
						</br>① < 인포랩 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</br>
						...
						</br>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</br>1. 파기절차</br> < 인포랩 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < 인포랩 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.</br>
					</p>
					...
					<p class='lh6 bs4'>
						<strong>제6조(개인정보의 안전성 확보 조치)<em class="emphasis"></br>
							</br>< 인포랩 ></em>은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
						</strong>
					</p>
					<p class='sub_p mgt10'>
						...
						</br>4. 해킹 등에 대비한 기술적 대책</br> <<em class="emphasis">인포랩</em>>('<em class="emphasis">거리영상설문사이트</em>')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.</br>
					...
					<p class="ls2">
						<br />
						<br />인포랩 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.
					<p class='sub_p mgt30'>
						<strong>제8조 (개인정보 보호책임자) </strong>
					</p>
					<p class='sub_p mgt10'>
						① <span class='colorLightBlue'>인포랩</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
					</p>
					<ul class='list_indent2 mgt10'>
						...
						<li>직책 :대표</li>
						<li>직급 :대표이사</li>
						<li>연락처 :010-6698-1221, ykhid@nate.com,</li>
					</ul>
					...
					<p class='sub_p'>② 정보주체께서는 인포랩 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 인포랩 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p>
					<p class='sub_p mgt30'>
						<strong>제9조(개인정보 열람청구)</br> 정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.<br />< 인포랩 ></span>은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
						</strong>
					</p>
					<ul class='list_indent2 mgt10'>
					...
					<p class='sub_p'>① 이 개인정보처리방침은 2021년 11월 25부터 적용됩니다.</p>
					<p class='sub_p'></p>
					<p class='sub_p'></p>
		...
		<div class="modal-dialog modal-dialog-centered" role="document" style="color: #000;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p class="ls2">태스크는 2개의 거리영상셋 중에서 좀 더 보행환경에 적합한 영상을 선택하는 것으로 수행됩니다. 하나의 태스크는 50개의 평가영상셋과 5개의 정답이 있는 영상셋으로 구성되어있습니다. 평가자들(워커)은 55개의 영상셋을 평가하고, 그 중 5개의 정답영상에 대해 평가 적합성을 판단하여 보상을 받게됩니다. 5개의 정답영상 중 2개이상 틀릴경우, 그 태스크는 재평가를 받아야하며 재평가에 대한 평가 적합성이 유효할 경우 보상을 받을 수 있습니다.</p>
					</br>					
					<p class="ls2">2. 태스크 횟수 및 보상</p>
					<ul class='list_indent2 mgt10'>
						<li>태스크 횟수 : 최대 50회</li>
						<li>보 상 : 태스크 당 1,200원</li>
					</ul>
					</br>
					...
					<p class="ls2">모든 태스크 수행이 완료된 후 참여자들은 보상 금액을 수령하실 통장 사본과 지급내역서 등을 작성 하신후 제출해 주셔야 하며, 보상 기간은 2022년 1월 20일부터 순차적으로 처리될 예정입니다.</p>
					</br>
					</p>
				</div>
			</div>
